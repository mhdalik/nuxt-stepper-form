...
const selectedColumns = ref(props.columnsAll)
const columnsTable = computed(() => props.columnsAll.filter((column) => selectedColumns.value.includes(column)))
    ...
    <UCard class="w-full" :ui="{
        ...
        <div class="flex justify-between items-center w-full px-4 py-3">
            ...
            <div class="flex gap-1.5 items-center">
                ...
                <USelectMenu v-model="selectedColumns" :options="columnsAll" multiple>
        ...
        <UTable v-model="selectedRows" v-model:sort="sort" :rows="todos" :columns="columnsTable" :loading="pending"
            ...
            class="w-full" :ui="{ td: { base: 'max-w-[0] truncate' } }" @select="select">
